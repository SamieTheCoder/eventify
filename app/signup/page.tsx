    ...
    return (
      <div className="flex min-h-screen flex-col bg-zinc-950">
        <header className="px-6 pt-6 sm:px-8">
          <Link
            href="/"
            className="inline-flex items-center gap-1.5 text-[15px] font-semibold tracking-tight text-zinc-100 hover:text-zinc-300"
          >
            <svg
              width="16"
              height="16"
        ...
        <div className="w-full max-w-sm space-y-7">
          <div>
            ...
            <p className="mt-1.5 text-sm text-zinc-400">
              Start tracking your work with Eventify
            </p>
          </div>
