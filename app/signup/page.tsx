    ...
    return (
      <div className="flex min-h-screen flex-col bg-zinc-950">
        <header className="px-6 pt-6 sm:px-8">
          <Link href="/" className="inline-flex items-center gap-1.5 text-[15px] font-semibold tracking-tight text-zinc-100 hover:text-zinc-300">
        ...
        <main className="flex flex-1 items-center justify-center px-4 py-12">
          <div className="w-full max-w-sm space-y-6 text-center">
            ...
            <Link href="/login" className="block text-sm text-zinc-500 hover:text-zinc-300">
              ← Back to login
            </Link>
          </div>
        </main>
      ...
      <main className="flex flex-1 items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm space-y-7">
          ...
          <div>
            ...
            <p className="mt-1.5 text-sm text-zinc-400">Start tracking your work with Eventify</p>
          </div>
          ...
          <p className="text-center text-sm text-zinc-500">
            ...
            <Link href="/login" className="font-semibold text-zinc-100 underline-offset-4 hover:underline">
              Login
            </Link>
          </p>
